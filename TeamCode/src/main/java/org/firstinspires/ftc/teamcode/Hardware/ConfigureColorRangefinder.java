...
public class ConfigureColorRangefinder extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ColorRangefinder crf =
                new ColorRangefinder(hardwareMap.get(RevColorSensorV3.class, "distanceOnePrgm"));
        ...
        neither   --> no object
         */
//        crf.setPin0Digital(ColorRangefinder.DigitalMode.DISTANCE, 180 / 360.0 * 255, 250 / 360.0 * 255); // blue
